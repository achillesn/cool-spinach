...
excerpt: Για ν’ αποκτήσουν οι εικόνες το λόγο που τους αρμόζει, είναι απαραίτητη η
  ...
  καταστάσεις πραγμάτων. Ο απεικονιστής τους χάρισε την παγωμένη τους αθανασία. Ο
  θεατής, καλείται να τις επαναφέρει στη ζωή.
canonical_url: "/images/articel 1-1.jpg"
